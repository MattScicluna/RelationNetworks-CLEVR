...
def build_dictionaries(clevr_dir, save_dir):
    ...
    cached_dictionaries = os.path.join(save_dir, 'questions', 'CLEVR_built_dictionaries.pkl')
    ...
    if not os.path.exists(os.path.join(save_dir, 'questions')):
        os.mkdir(os.path.join(save_dir, 'questions'))
